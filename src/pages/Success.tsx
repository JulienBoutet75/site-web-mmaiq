  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] text-white flex items-center justify-center p-6">
      <motion.div 
        ...
        className="max-w-md w-full bg-[#12122a] border border-[#a020f0]/30 rounded-[2rem] p-10 text-center shadow-[0_0_50px_rgba(160,32,240,0.2)]"
      >
        ...
        <div className="space-y-4">
          <Link to="/instructional">
            <Button className="w-full py-4 rounded-xl bg-[#a020f0] hover:bg-[#b848ff] flex items-center justify-center gap-2">
