...
export function Button({
  ...
  const variants = {
    primary:
      "bg-[var(--color-accent-primary)] text-white shadow-[0_0_20px_rgba(123,47,255,0.3)] hover:bg-[var(--color-violet-600)] hover:shadow-[0_0_30px_rgba(123,47,255,0.5)] hover:-translate-y-0.5",
