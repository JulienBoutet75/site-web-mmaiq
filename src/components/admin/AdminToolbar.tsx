...
export function AdminToolbar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] h-[56px] bg-[#0a0a16]/80 backdrop-blur-[12px] border-t-2 border-[#a020f0] px-6 flex items-center justify-between shadow-[0_-10px_30px_rgba(160,32,240,0.1)]">
      ...
      <div className="flex items-center gap-2">
        <Link
          to="/admin"
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#a020f0] to-[#6d13a6] hover:from-[#b030ff] hover:to-[#7d23b6] text-white text-sm rounded-full font-bold transition-all shadow-[0_0_15px_rgba(160,32,240,0.4)] hover:shadow-[0_0_25px_rgba(160,32,240,0.6)] hover:-translate-y-0.5"
        >
          <ShieldCheck size={18} />
          Mode Super Admin
        </Link>
